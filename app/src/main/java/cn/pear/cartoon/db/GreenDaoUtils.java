package cn.pear.cartoon.db;

import android.database.sqlite.SQLiteDatabase;

import cn.pear.cartoon.bean.DaoMaster;
import cn.pear.cartoon.bean.DaoSession;
...
public class GreenDaoUtils {
    ...
    private void initGreenDao(){
        mHelper=new DaoMaster.DevOpenHelper(MyApplication.getInstance(),"cartoon.db",null);
